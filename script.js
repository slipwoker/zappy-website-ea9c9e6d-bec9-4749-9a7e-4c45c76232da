document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            const name = input.name || input.id || 'This field';
        ...
        contactForm.addEventListener('blur', function(e) {
            ...
            if (input.matches('input, textarea, select')) {
                if (input.value.trim() !== '' || input.classList.contains(errorClass)) {
                    validateField(input);
                }
            }
        }, true);
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ea9c9e6d-bec9-4749-9a7e-4c45c76232da',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ea9c9e6d-bec9-4749-9a7e-4c45c76232da';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ea9c9e6d-bec9-4749-9a7e-4c45c76232da';
